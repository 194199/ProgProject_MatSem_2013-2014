...
public class BankManagementPanel extends javax.swing.JFrame implements MainFrame {
    ...
    private static final String SERVER_ADDRESS = "192.168.137.223";
        ...
        managementPanelLayout.setHorizontalGroup(
            ...
            .addGroup(managementPanelLayout.createSequentialGroup()
                ...
                .addGroup(managementPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(customerInfoPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, managementPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(qrButton, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(exitPaneButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
            .addGroup(managementPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, managementPanelLayout.createSequentialGroup()
    ...
    private void qrButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_qrButtonActionPerformed
        if (accountList.getSelectedValue() != null) {
            try {
            //    String ipAddress = InetAddress.getByName("mth-U52F.mshome.net").getHostAddress();
           //     String port = ""+1357;
                String accNumber = ((AccountCard)accountList.getSelectedValue()).getAccountNumber();
                
                String toEncode = 
                        //ipAddress+"##"+port+"##"+accNumber;
                        SERVER_ADDRESS+"##1357##"+accNumber;
                
                MultiFormatWriter barcodeWriter = new MultiFormatWriter();
                BitMatrix matrix;
                matrix = barcodeWriter.encode(toEncode, BarcodeFormat.QR_CODE, 600, 600);
                
                
                JDialog dial = new JDialog(this);
                dial.setSize(new Dimension(650,650));
                JLabel label = new JLabel();
                dial.add(label);
                label.setIcon(new ImageIcon(MatrixToImageWriter.toBufferedImage(matrix)));
                dial.setVisible(true);
                
                
                
       //     } catch (UnknownHostException ex) {
       //         Logger.getLogger(BankManagementPanel.class.getName()).log(Level.SEVERE, null, ex);
